...
def test_channel_message_invalid_index(user_list, channel_id):
    ...
    with pytest.raises(InputError):
        channel_messages_v1(user_1, channel_id, 1)
    with pytest.raises(InputError):
...
def test_invalid_user(user_list, channel_id):
    ...
    user_2 = auth_login_v2("z5270202@ad.unsw.edu.au", "Pet123")['auth_user_id']
    user_3 = auth_login_v2("z5201314@ad.unsw.edu.au", "Bojin123")['auth_user_id']
    user_4 = auth_login_v2("12345678@qq.com", "Cicy123")['auth_user_id']

    with pytest.raises(AccessError):
        channel_messages_v1(user_2, channel_id, 0)
    with pytest.raises(AccessError):
