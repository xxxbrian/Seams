...
def creat_channels():
    ...
    """
    user_1 = auth_login_v1("z5374603@ad.unsw.edu.au", "Ymc123")["u_id"]
...
def test_channel_details_user_not_in_channel(channel_id):
    user_2 = auth_login_v1("z5201314@ad.unsw.edu.au", "Bojin123")["u_id"]
    with pytest.raises(AccessError):
        channel_details_v1(user_2, channel_id)
    user_3 = auth_login_v1("12345678@qq.com", "Cicy123")['u_id']
    with pytest.raises(AccessError):
...
def test_channel_details_two_join_member(channel_id):  
    user_1 = auth_login_v1("z5374603@ad.unsw.edu.au", "Ymc123")["u_id"]
    user_2 = auth_login_v1("z5201314@ad.unsw.edu.au", "Bojin123")["u_id"]
    user_3 = auth_login_v1("12345678@qq.com", "Cicy123")['u_id']
    channel_join_v1(user_2, channel_id)
